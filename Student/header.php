                ...
                <div class="d-flex sidebar-account flex-shrink-0 mr-auto mr-lg-0">
                    <a href="index.html" class="flex d-flex align-items-center text-underline-0">
                        ...
                        <span class="flex d-flex flex-column text-white">
                            <strong class="sidebar-brand">Gutwara</strong>
                        </span>
                    </a>
                </div>
                ...
                <div class="dropdown">
                    <a href="#account_menu" class="dropdown-toggle navbar-toggler navbar-toggler-dashboard border-left d-flex align-items-center ml-navbar" data-toggle="dropdown">
                        ...
                        <span class="ml-1 d-flex-inline">
                            <span class="text-light"><?php echo $current_user["names"];?></span>
                        </span>
                    </a>
                    <div id="company_menu" class="dropdown-menu dropdown-menu-right navbar-company-menu">
                        <div class="dropdown-item d-flex align-items-center py-2 navbar-company-info py-3">
                            ...
                            <span class="flex d-flex flex-column">
                                <strong class="h5 m-0"><?php echo $current_user["role"];?></strong>
                                <small class="text-muted text-uppercase"><?php echo $current_user["phone"];?></small>
                            </span>
                        ...
                        <a class="dropdown-item d-flex align-items-center py-2" href="profile.php">
                            <span class="material-icons mr-2">settings</span> Igenamiterere
                        </a>
                        <a class="dropdown-item d-flex align-items-center py-2" href="../auth/logout.php">
                            <span class="material-icons mr-2">exit_to_app</span> Sohoka
                        </a>
                    </div>
                </div>
